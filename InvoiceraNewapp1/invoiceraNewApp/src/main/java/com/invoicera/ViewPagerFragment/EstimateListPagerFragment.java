...
public class EstimateListPagerFragment extends EstimateList implements
   ...
   /*             if (isActionPopOpen)
                ...
                if (adapter.estimateList.get(position).getStatus().equalsIgnoreCase("Cancel") || adapter.estimateList.get(position).getStatus().equalsIgnoreCase("Deleted")|| adapter.estimateList.get(position).getStatus().equalsIgnoreCase("Delete")) {
