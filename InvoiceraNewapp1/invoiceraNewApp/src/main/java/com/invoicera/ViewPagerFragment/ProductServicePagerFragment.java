        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isProductSelected) {
                    ...
                    arguments.putParcelable(Constant.KEY_DATA, productsList.get(position));
                    arguments.putString(Constant.KEY_TYPE, "Product");
                } else {

                    arguments.putParcelable(Constant.KEY_DATA, servicesList.get(position));
...
/*        if (parentFragment.isFilterEnable) {
        ...
        if (isProductSelected) {
            if (parentFragment.isProductFilterEnable) {
                parentFragment.isProductFilterEnable = false;
                return;

            }
        } else {

            if (parentFragment.isServiceFilterEnable) {
                parentFragment.isServiceFilterEnable = false;
                return;
            }
        }
