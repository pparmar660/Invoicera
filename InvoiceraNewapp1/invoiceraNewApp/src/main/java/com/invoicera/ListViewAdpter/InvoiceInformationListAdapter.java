 ...
 */
public class InvoiceInformationListAdapter extends BaseAdapter {
    ...
    public InvoiceInformationListAdapter(Context context, String currency, ArrayList<InvoiceInformation> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dataList.get(position).getRow_type() == Constant.INFORMATION_ROW_TYPE.HEADER) {
            ...
            if (dataList.get(position).getType().equalsIgnoreCase("Create")) {
                ...
                typeTV.setText(dataList.get(position).getCreatedBy() + " Created Invoice to " + dataList.get(position).getCreatedFor() + " of " + InvoicePreviewPagerFragment.ClientCurrency + " " + dataList.get(position).getAmount());
            }

            if (dataList.get(position).getType().equalsIgnoreCase("Edit")) {
                typeTV.setText(dataList.get(position).getCreatedBy() + " Edited Invoice to " + dataList.get(position).getCreatedFor() + " of " + InvoicePreviewPagerFragment.ClientCurrency + " " + dataList.get(position).getAmount());

            }
            if (dataList.get(position).getType().equalsIgnoreCase("Sent")) {
                typeTV.setText(dataList.get(position).getCreatedBy() + " Emailed Invoice to " + dataList.get(position).getCreatedFor() + " of " + InvoicePreviewPagerFragment.ClientCurrency + " " + dataList.get(position).getAmount());
    ...
    boolean isLastElementOfDay(InvoiceInformation model) {
