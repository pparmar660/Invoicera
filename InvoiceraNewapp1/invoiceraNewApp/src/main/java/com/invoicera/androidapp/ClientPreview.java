...
public class ClientPreview extends BaseActivity implements View.OnClickListener, WebApiResult {
    ...
    Calendar myCalendar;
    TextView fromDateTv, toDateTv, editTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createInvoiceTV.setOnClickListener(this);
        createEstimateTV.setOnClickListener(this);
        ...
        switch (v.getId()) {
            ...
            case  R.id.addInvoice:
                ...
                try {
                    ...
                    arguments.putString(Constant.KEY_ADDRESS,clientObject.getString("billing_address"));
                    arguments.putString(Constant.KEY_CLIENT_NAME,clientObject.getString("name"));
                    arguments.putString(Constant.KEY_ORGANIZATION,clientObject.getString("organization"));
                    arguments.putString(Constant.KEY_CLIENT_ID,clientObject.getString("client_id"));
                    arguments.putString(Constant.KEY_CLIENT_CURRENCY,clientObject.getString("currency"));
                    i.putExtra("isAddEstimate","false");

                    i.putExtra(Constant.KEY_CLIENT, arguments);
...
// We need to get the instance of the LayoutInflater
            ...
            addCredit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra(Constant.KEY_CREDIT, creditAmount);
                    i.putExtra(Constant.KEY_COMPANY_ID,ClientUserCompanyID);
                    startActivity(i);
                    viewLinear.setAlpha(1f);
                    popupWindow.dismiss();
