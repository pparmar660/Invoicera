    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                arguments.putString(Constant.KEY_EXPENSE_ID, adapter.expenseList.get(position).getExpense_id());
                // arguments.putString(Constant.KEY_INVOICE_STATUS, acontent[parentFragment.selectedPagePosition]);
                arguments.putInt(Constant.KEY_POSITION, 1);

                if (global.isNetworkAvailable()) {
                    fragmentChanger.onFragmentAddWithBackStack(new ExpenseCreateEdit(), Constant.InvoicePreviewCreateFragmentTag, arguments);
...
/*
                ...
                parentFragment.expenseId = adapter.expenseList.get(position).getExpense_id();
                parentFragment.expenseNoTV.setText(adapter.expenseList.get(position).getCategory());
                parentFragment.position = position;

                if (adapter.expenseList.get(position).getStatus().equalsIgnoreCase("Cancel") || adapter.expenseList.get(position).getStatus().equalsIgnoreCase("Deleted")) {
                ...
                } else if (adapter.expenseList.get(position).getStatus().equalsIgnoreCase("Archived")) {
    ...
    public void getExpenseList(int page_no, Constant.SERVICE_TYPE type,
     ...
     /*   int i1=0;
        ...
        obj.put("amount_status", ExpenseList.content[position]);
    ...
    private void updateUI(JSONObject jsonreturn) {
        ...
        try {
            ...
            for (int i = 0; i < expense.length(); i++) {
                ...
                atribute.setCategory(c.getString("category"));
