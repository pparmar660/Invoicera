...
public class SelectPaymentGateWay extends BaseActivity implements WebApiResult, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getSerializableExtra(Constant.KEY_PAYMENT_GATEWAY) != null) {

            adapter.selectedList = (ArrayList<HashMap<String, String>>) intent.getSerializableExtra(Constant.KEY_PAYMENT_GATEWAY);
        ...
        switch (v.getId()) {
            ...
            case R.id.save:
                ...
                for (int i = 0; i < adapter.getCount(); i++) {
                    ...
                    intent.putExtra(Constant.KEY_PAYMENT_GATEWAY, adapter.selectedList);
                    setResult(Constant.requestCodeSelectPaymentGateway, intent);
